 ...
 * @date 2019-08-21
 */
public interface L3sum {
    List<List<Integer>> threeSum(int[] nums);

    class Solution1 implements L3sum {
        @Override
    ...
    class Solution2 implements L3sum {
        @Override
        public List<List<Integer>> threeSum(int[] nums) {
    ...
    class Solution3 implements L3sum {
        @Override
        public List<List<Integer>> threeSum(int[] nums) {
     ...
     * 9%
     */
    class Solution4 implements L3sum {
    ...
    class Solution5 implements L3sum {
    ...
    class Solution6 implements L3sum {
        @Override
        public List<List<Integer>> threeSum(int[] nums) {
            Arrays.sort(nums);
            HashMap<Integer, List<Integer>> m = HashMap.newHashMap(nums.length + 1);
            for (int i = 0; i < nums.length; i++) {
            ...
            for (int i = 0; i < nums.length - 1; i++) {
                ...
                for (int j = i + 1; j < nums.length; j++) {
                    ...
                    List<Integer> ks = m.getOrDefault(-(nums[i] + nums[j]), List.of());
...
class L3sumTest extends AbstractTest<L3sum> {
    @Override
    protected Testsuite<L3sum> testsuite() {
        return Testsuite.<L3sum>builder()
