...
public interface JumpGameII {
    ...
    static Testsuite<JumpGameII> testsuite() {
        return Testsuite.<JumpGameII>builder()
                .addExpected(t -> t.jump(new int[]{2, 3, 1, 1, 4}), 2)
                .addExpected(t -> t.jump(new int[]{0}), 0)
                .addExpected(t -> t.jump(new int[]{1, 2}), 1)
                .addExpected(t -> t.jump(new int[]{3, 2, 1, 0}), 1)
                .build();
    }
