package com.leammin.leetcode.todo.easy;
...
public interface MaximumRepeatingSubstring {
    ...
    static Testsuite<MaximumRepeatingSubstring> testsuite() {
        return Testsuite.<MaximumRepeatingSubstring>builder()
            .addExpected(t -> t.maxRepeating("ababc", "ab"), 2)
            .addExpected(t -> t.maxRepeating("ababc", "ba"), 1)
            .addExpected(t -> t.maxRepeating("ababc", "ac"), 0)
            .addExpected(t -> t.maxRepeating("ababc", "a"), 1)
            .addExpected(t -> t.maxRepeating("aaabaab", "aab"), 2)
            .addExpected(t -> t.maxRepeating("ababaaba", "aba"), 2)
            .addExpected(t -> t.maxRepeating("aaaaaa", "aaa"), 2)
            .build();
    }

    class Solution implements MaximumRepeatingSubstring {
...
class MaximumRepeatingSubstringTest
    extends AbstractTest<MaximumRepeatingSubstring> {}
