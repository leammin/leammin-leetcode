...
public interface ConvertTheTemperature {
    ...
    static Testsuite<ConvertTheTemperature> testsuite() {
        return Testsuite.<ConvertTheTemperature>builder()
                .addExpected(t -> t.convertTemperature(36.50), new double[]{309.65000,97.70000})
                .build();
    }

    class Solution implements ConvertTheTemperature {
...
class ConvertTheTemperatureTest extends AbstractTest<ConvertTheTemperature> {
}
