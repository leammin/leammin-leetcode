 ...
 * @date 2023-03-17
 */
public interface MinimumHoursOfTrainingToWinACompetition {
    int minNumberOfHours(int initialEnergy, int initialExperience, int[] energy, int[] experience);

    static Testsuite<MinimumHoursOfTrainingToWinACompetition> testsuite() {
        return Testsuite.<MinimumHoursOfTrainingToWinACompetition>builder()
                .addExpected(t -> t.minNumberOfHours(5, 3, new int[]{1,4,3,2}, new int[]{2,6,3,1}), 8)
                .build();
    }

    class Solution implements MinimumHoursOfTrainingToWinACompetition {
        ...
        public int minNumberOfHours(int initialEnergy, int initialExperience, int[] energy, int[] experience) {
            ...
            int res = Math.max(0, sumEnergy - initialEnergy + 1);
...
class MinimumHoursOfTrainingToWinACompetitionTest extends AbstractTest<MinimumHoursOfTrainingToWinACompetition> {
}
