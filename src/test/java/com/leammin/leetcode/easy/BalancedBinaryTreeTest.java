...
class BalancedBinaryTreeTest extends AbstractTest<BalancedBinaryTree> {
    ...
    protected Testsuite<BalancedBinaryTree> testsuite() {
        return Testsuite.<BalancedBinaryTree>builder()
                .add(ExpectedTestcase.of(true, t -> t.isBalanced(TreeNode.of(3, 9, 20, null, null, 15, 7))))
                .add(ExpectedTestcase.of(false, t -> t.isBalanced(TreeNode.of(1,2,2,3,3,null,null,4,4))))
                .build();
    }
}